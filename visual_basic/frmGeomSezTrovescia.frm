...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmGeomSezTrovescia 
   ...
   ClientTop       =   624
   ClientWidth     =   15204
   OleObjectBlob   =   "frmGeomSezTrovescia.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmGeomSezTrovescia"
...
With Foglio2
    ...
    .Cells(6, 23) = (B - Bo) / 2 'coordinate 1° vertice
    .Cells(6, 24) = 0
    .Cells(7, 23) = (B - Bo) / 2  '2° vertice
    .Cells(7, 24) = H - S
    .Cells(8, 23) = 0 '3° vertice
    .Cells(8, 24) = H - S
    .Cells(9, 23) = 0 '4° vertice
    .Cells(9, 24) = H
    .Cells(10, 23) = B '5°
    .Cells(10, 24) = H
    .Cells(11, 23) = B '6°
    .Cells(11, 24) = H - S
    .Cells(12, 23) = (B + Bo) / 2 '7°
    .Cells(12, 24) = H - S
    .Cells(13, 23) = (B + Bo) / 2 '8°
    .Cells(13, 24) = 0
    If optDueLembi Then
        ...
        Else
            .Cells(3, 42) = 0 'Npacch
        End If
        .Cells(5, 38) = (B - Bo) / 2 + DeltaSup
        .Cells(5, 39) = DeltaSup
        .Cells(5, 40) = (B + Bo) / 2 - DeltaSup
        .Cells(5, 41) = DeltaSup
        .Cells(5, 42) = txtNbs
        .Cells(5, 43) = cmbDbs
        .Cells(6, 38) = DeltaInf
        .Cells(6, 39) = H - DeltaInf 'z'iniz
        .Cells(6, 40) = B - DeltaInf
