...
- DA COMPLETARE
- Note sintetiche:
  - Norme menzionate: | Norma | Articolo/Tab | Contenuto |, | --- | --- | --- |, | NTC2018 | §3.2.1 | Pericolosità sismica, interpolazione TR log-lineare |, | NTC2018 | Tab. 3.2.V | Coefficiente CC per categoria suolo |, | NTC2018 | Tab. 3.2.II | Categoria suolo A–E: SS, TB, TC, TD |...
