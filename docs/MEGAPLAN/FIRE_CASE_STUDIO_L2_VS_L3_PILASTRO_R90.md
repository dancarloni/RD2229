...
1. Dati geometrici e meccanici (input comune)
3.1 Geometria
...
1. Verifica con metodo L2 – Sezione efficace
...
1. Analisi con metodo L3 – FEM beam‑fiber
...
1. Uso corretto dei risultati L3
