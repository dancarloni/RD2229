...
1. Inquadramento normativo (NTC2018 – Capitolo 7)
Secondo NTC2018 §7:
...
1. Ruolo della capacità sismica Rd
...
1. Modello dati – Elementi e meccanismi
...
1. Modello dati – Verifica di gerarchia
...
1. Classe di verifica gerarchia (CAP_7)
