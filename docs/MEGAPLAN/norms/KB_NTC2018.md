...
1. Impianto concettuale della norma
...
1. Struttura generale delle NTC 2018
...
1. Analisi strutturale (concetti generali)
...
1. Rapporto con norme precedenti (TA)
Le NTC 2018:
...
1. Estensioni previste (KB di secondo livello)
