...
1. Descrizione dell’elemento strutturale
...
1. Dati geometrici e meccanici (input comuni)
...
1. Verifica con metodo L2 – Approccio semplificato
...
1. Analisi con metodo L3 2D a caldo
...
1. Confronto diretto L2 vs L3 2D
...
1. Uso corretto dei risultati L3 2D
