...
1. Dati di base (immutati rispetto a R90)
2.1 Geometria
...
1. Verifica con metodo L2 – Estensione a R120
3.1 Impostazione
...
1. Analisi con metodo L3 2D a caldo – R120
...
1. Implicazioni per benchmark e relazione di calcolo
