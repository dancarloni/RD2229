...
1. Ambito dello Step 2 (controllato)
...
1. Leggi costitutive a caldo (livello prototipale)
...
1. Calcolo della capacità resistente nel tempo
Per ogni istante \\(t\\):
...
1. Interfaccia del modulo meccanico
...
1. Gate di avanzamento allo Step 3
