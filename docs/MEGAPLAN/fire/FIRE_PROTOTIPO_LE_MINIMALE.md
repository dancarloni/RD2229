...
1. Architettura target del sistema
...
1. Strategia di sviluppo incrementale
...
1. Output e integrazione nel sistema
...
1. Responsabilità e limiti di utilizzo
