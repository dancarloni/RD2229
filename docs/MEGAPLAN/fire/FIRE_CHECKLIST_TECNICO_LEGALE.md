...
1. Checklist normativa (obbligatoria)
...
1. Checklist del metodo di calcolo
...
1. Checklist di verifica strutturale
...
1. Checklist di output e risultati
...
1. Checklist di tracciabilità e riproducibilità
...
1. Checklist software (se applicabile)
