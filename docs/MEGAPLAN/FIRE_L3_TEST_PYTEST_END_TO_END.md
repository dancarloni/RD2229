...
1. Fixture comuni e mock controllati
...
1. Test NOT_OK end‑to‑end (collasso anticipato)
...
1. Sensibilità al passo temporale (Δt)
...
1. Aggancio al Gate di rilascio
