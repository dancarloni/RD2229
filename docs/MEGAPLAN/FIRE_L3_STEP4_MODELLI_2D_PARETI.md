...
1. Perché aprire la linea 2D (pareti)
...
1. Ambito dello STEP 4 (iniziale e controllato)
...
1. Analisi meccanica 2D (STEP 4.2)
6.1 Stato di sforzo
...
1. Accoppiamento termo‑meccanico 2D
Schema concettuale:
...
1. Criteri di collasso per pareti
...
1. Gate di avanzamento linea 2D
...
1. Evoluzione futura (STEP successivi)
