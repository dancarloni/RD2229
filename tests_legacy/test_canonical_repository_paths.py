...
from sections_app.services.repository import DEFAULT_JSON_FILE as SECTIONS_DEFAULT
...
class TestSectionRepositoryCanonicalPath:
    ...
    def test_section_repository_uses_canonical_path_by_default(self):
        ...
        assert (
            repo._json_file == SECTIONS_DEFAULT
    ...
    def test_section_repository_creates_canonical_directory(self):
        ...
        assert os.path.exists(canonical_dir), f"Directory {canonical_dir} dovrebbe esistere"
    ...
    def test_section_repository_save_creates_file_in_canonical_path(self, tmpdir):
        ...
        section = RectangularSection(name="Test Rect", width=30.0, height=50.0)
