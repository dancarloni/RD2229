...
from historical_ta.stress import LoadState, compute_normal_stresses_ta, StressResult
...
class TestHistoricalTA(unittest.TestCase):
    ...
    def test_allowable_check(self):
        sr = StressResult(sigma_c_max=-10.0, sigma_c_min=-20.0, sigma_c_pos=0, sigma_c_neg=-20, sigma_c_med=-5, sigma_s_max=100, sigma_s_array=[100], sigma_vertices=[-10])
