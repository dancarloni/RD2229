...
def test_main_window_save_creates_section_with_principals(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("apps.sections.ui.main_window.notify_info", lambda *a, **k: None)
    monkeypatch.setattr("apps.sections.ui.main_window.notify_error", lambda *a, **k: None)
