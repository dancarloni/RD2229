<<<<<<< HEAD:tests/test_frc_verification_window.py
import unittest
...
class TestFrcVerificationWindow(unittest.TestCase):
    ...
    def test_run_without_material_shows_output(self):
        with patch('tkinter.Tk.mainloop'):
            ...
            try:
                win.ent_b.delete(0, tk.END); win.ent_b.insert(0, "20")
                win.ent_h.delete(0, tk.END); win.ent_h.insert(0, "40")
                win.ent_As.delete(0, tk.END); win.ent_As.insert(0, "2")
                win.ent_d.delete(0, tk.END); win.ent_d.insert(0, "35")
                win.ent_M.delete(0, tk.END); win.ent_M.insert(0, "1000")
                win.ent_area.delete(0, tk.END); win.ent_area.insert(0, "0.0")
                win._run()
...
if __name__ == "__main__":
    unittest.main()
>>>>>>> 7d17959e67335d1598aebfe93ebc3ee7c638c805:tests_legacy/test_frc_verification_window.py
