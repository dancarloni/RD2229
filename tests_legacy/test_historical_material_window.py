<<<<<<< HEAD:tests/test_historical_material_window.py
import tempfile
import unittest
...
class TestHistoricalMaterialWindow(unittest.TestCase):
    def setUp(self):
        ...
        # Add some items
        hm1 = HistoricalMaterial(id="HM1", code="HM1", name="CLS R 160", source="RD 2229/39", type=HistoricalMaterialType.CONCRETE, fck=16.0)
        hm2 = HistoricalMaterial(id="HM2", code="HM2", name="Acciaio B450C", source="SomeStd", type=HistoricalMaterialType.STEEL, fyk=450.0)
        self.lib.add(hm1)
        self.lib.add(hm2)
    ...
    def test_add_and_delete(self):
        ...
        new = HistoricalMaterial(id="HM_NEW", code="HM_NEW", name="New Mat", source="RD", type=HistoricalMaterialType.OTHER)
        self.lib.add(new)
        win._refresh_table()
        codes = [win.tree.set(i, "code") for i in win.tree.get_children()]
...
if __name__ == "__main__":
    unittest.main()
>>>>>>> 7d17959e67335d1598aebfe93ebc3ee7c638c805:tests_legacy/test_historical_material_window.py
