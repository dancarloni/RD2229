<<<<<<< HEAD:tests/test_verification_comparator_visuals.py
import pytest
...
def test_shaded_polygon_prefers_top_or_bottom_based_on_stresses():
    ...
    r_top.asse_neutro = 10.0
    r_top.inclinazione_asse_neutro = 0.0
    poly_top = VerificationComparatorWindow._compute_shaded_polygon(
        b,
        h,
        (b / 2.0, r_top.asse_neutro),
        r_top.inclinazione_asse_neutro,
    ...
    r_bot.asse_neutro = 10.0
    r_bot.inclinazione_asse_neutro = 0.0
    poly_bot = VerificationComparatorWindow._compute_shaded_polygon(
        b,
        h,
        (b / 2.0, r_bot.asse_neutro),
        r_bot.inclinazione_asse_neutro,
        pick_side_point=(b / 2.0, h),
    )
    assert point_in_poly(b / 2.0, h, poly_bot)
...
def test_compute_na_endpoints_diagonal():
    ...
    assert on_edge(e1)
    assert on_edge(e2)
>>>>>>> 7d17959e67335d1598aebfe93ebc3ee7c638c805:tests_legacy/test_verification_comparator_visuals.py
