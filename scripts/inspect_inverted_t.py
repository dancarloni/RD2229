...
from apps.sections.models.sections import InvertedTSection
from apps.sections.section_calculations import section_to_geometry
...
from apps.sections.section_calculations import _polygon_area_and_centroid
