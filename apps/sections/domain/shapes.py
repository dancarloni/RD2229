...
class TSection(Section):
    ...
    def _compute_geometric_properties(self) -> SectionProperties:
        ...
        # Flangia
        ix_flange = (flange_width * flange_thickness**3) / 12 + area_flange * (y_flange - y_g) ** 2
        iy_flange = (flange_thickness * flange_width**3) / 12

        # Anima
        ix_web = (web_thickness * web_height**3) / 12 + area_web * (web_height / 2 - y_g) ** 2
...
class LSection(Section):
    ...
    def _compute_geometric_properties(self) -> SectionProperties:
        ...
        # Area
        area = width * t_horizontal + (height - t_horizontal) * t_vertical
        ...
        x_g = (area_horizontal * x_horizontal + area_vertical * x_vertical) / area
        y_g = (area_horizontal * y_horizontal + area_vertical * y_vertical) / area
...
class RectangularHollowSection(Section):
    ...
    def _compute_geometric_properties(self) -> SectionProperties:
        ...
        # Core section
        core_x = Iy / (area * (width / 2))
        core_y = Ix / (area * (height / 2))
...
class InvertedTSection(Section):
    ...
    def _compute_geometric_properties(self) -> SectionProperties:
        ...
        x_g = flange_width / 2
        y_g = (area_flange * y_flange + area_web * (flange_thickness + web_height / 2)) / area
...
class VSection(Section):
    ...
    def _compute_geometric_properties(self) -> SectionProperties:
        ...
        area = width * height / 2 * thickness  # Area volumetrica semplificata
