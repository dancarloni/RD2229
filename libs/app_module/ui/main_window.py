...
class MainWindow(tk.Toplevel):
    ...
    def _create_menu(self) -> None:
        ...
        # Removed material manager as carbon_fiber_placeholder module should not depend on materials
    ...
    def _set_default_kappa_entries(self) -> None:
        ...
        try:
            ...
            try:
                from shear_factors_module.shear_factors import get_default_shear_factor
    ...
    def show_graphic(self) -> None:
        ...
        if not section:
            return
        # Ensure we have properties and carbon_fiber_placeholder
        try:
            shear_k = self._get_shear_factor_from_ui()
            props = compute_section_properties_from_section(section, shear_factor=shear_k)
    ...
    def _show_properties(self, props, section: Section) -> None:
        ...
        objects (models.sections.SectionProperties) and new apps.sections.geometry_model.SectionProperties.
        """
