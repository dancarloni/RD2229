...
from geometry.models.sections import CSV_HEADERS, Section  # type: ignore[import]
from geometry.services.event_bus import (
    SECTIONS_ADDED,
    SECTIONS_CLEARED,
    SECTIONS_DELETED,
    SECTIONS_UPDATED,
...
from geometry.services.repository import (  # type: ignore[import]
                ...
                try:
                    ...
                    if (
                        ...
                        try:
                            ...
                            logger.exception(
                                "Errore nel resettare la form di Geometry "
                                "dopo apertura da ModuleSelector"
                            )
                except Exception:
