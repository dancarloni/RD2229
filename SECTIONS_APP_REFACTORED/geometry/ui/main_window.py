...
from geometry.models.sections import (
...
from geometry.services.calculations import CanvasTransform, compute_transform
from geometry.services.notification import (
    notify_error,
    notify_info,
)

# New separated modules
from geometry.section_calculations import (
    compute_section_properties_from_section,
    compute_section_properties_from_geometry,
    section_to_geometry,
)
from geometry.section_graphics import SectionGraphicsController
from geometry.services.repository import CsvSectionSerializer, GeometryRepository
from geometry.ui.historical_material_window import (
    HistoricalMaterialWindow,  # type: ignore[import]
)
from geometry.ui.section_manager import SectionManager  # type: ignore[import]
...
class MainWindow(tk.Toplevel):
    ...
    def _populate_saved_list(self) -> None:
        ...
        try:
            from geometry.storage import import_sections_from_csv
    ...
    def _save_current_section(self) -> None:
        ...
        try:
            ...
            from geometry.storage import import_sections_from_csv, export_sections_to_csv
    ...
    def _set_default_kappa_entries(self) -> None:
        ...
        try:
            ...
            try:
                from geometry.shear_factors import get_default_shear_factor
