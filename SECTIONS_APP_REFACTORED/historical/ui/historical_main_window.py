...
from historical.services.historical_calculations import (
    verify_flexure_allowable_stress,
)
from historical.services.repository import SectionRepository  # type: ignore[import]
...
class HistoricalModuleMainWindow(tk.Toplevel):
    ...
    def __init__(self, master: tk.Tk, repository: SectionRepository | None = None):
        ...
        if repository is None:
            from historical.services.repository import SectionRepository
