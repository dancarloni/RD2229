...
from historical.services.calculations import compute_principal_inertia, rotate_inertia
...
class TSection(Section):
    ...
    def _compute(self) -> SectionProperties:
        ...
        ix_local = (
            ix_flange_local
            + area_flange * (y_flange - centroid_y) ** 2
            + ix_web_local
            + area_web * (y_web - centroid_y) ** 2
        )
...
class LSection(Section):
    ...
    def _compute(self) -> SectionProperties:
        from historical.services.calculations import (
            RectangleElement,
...
def create_section_from_dict(data: dict[str, str]) -> Section:
    ...
    if section_type == "RECTANGULAR":
        ...
        if (t_horizontal_val is None or t_horizontal_val == "") and (
