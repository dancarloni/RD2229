...
if importlib.util.find_spec("PySide6") is None and importlib.util.find_spec("PyQt6") is None:
...
def test_registry_factories(registry, services):
    ...
    for spec in registry.get_specs():
        ...
        try:
            ...
            window = factory(
                master=None, project_service=services.project_service, registry=registry
            )
