...
class TestTraveSA:
    ...
    def test_momento_massimo_al_centro(self) -> None:
        ...
        elem = ElementoFEM.da_nodi(
            0, nodo_i, nodo_j, E=self.E, A=self.A, I=self.I,
        ...
        diagrammi, u = _risolvi_sistema(
            [nodo_i, nodo_j], [elem], vincoli, n_punti=101
        )
        d = diagrammi[0]
...
class TestTraveSbalzo:
    ...
    def setup(self):
        ...
        return _risolvi_sistema(
            [nodo_i, nodo_j], [elem], vincoli, carichi_nodali, n_punti=51
        )
...
class TestPortaleUnPiano:
    ...
    def setup(self):
        ...
        e_trav = ElementoFEM.da_nodi(
            1, n2, n3, E=self.E, A=self.A_trav, I=self.I_trav, etichetta="traverso",
            carichi=[CaricoDistribuitoUniforme(intensita=self.q)],
        )
        ...
        return _risolvi_sistema(
            [n0, n1, n2, n3], [e_pil_sx, e_trav, e_pil_dx], vincoli, n_punti=21
        )
...
class TestTraveContinua2Campate:
    ...
    def setup(self):
        ...
        e0 = ElementoFEM.da_nodi(
            0, n0, n1, E=self.E, A=self.A, I=self.I,
            carichi=[CaricoDistribuitoUniforme(intensita=self.q)],
        )
        e1 = ElementoFEM.da_nodi(
            1, n1, n2, E=self.E, A=self.A, I=self.I,
            carichi=[CaricoDistribuitoUniforme(intensita=self.q)],
        )
