...
def _get_default_sources() -> list[MaterialSource]:
    ...
    return [
        MaterialSource(
            ...
            notes=(
                "Prima norma italiana organica sul cemento armato. Metodo n (tensioni ammissibili)."
            ),
        ),
        MaterialSource(
            id="DM72",
        ...
        MaterialSource(
            ...
            notes=(
                "Introduce il metodo semiprobabilistico agli stati limite come alternativa alle TA."
            ),
        ),
        MaterialSource(
            id="OPCM3274",
        ...
        MaterialSource(
            ...
            notes=(
                "Prima versione delle NTC. Metodo SL obbligatorio, TA ammesse solo per strutture semplici."
            ),
        ),
        MaterialSource(
            id="NTC2018",
