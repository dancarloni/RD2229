...
warnings.warn(
    "sections_app.ui.debug_viewer is deprecated and moved to src.legacy.sections_app.ui.debug_viewer",
    DeprecationWarning,
)

def _load_legacy():
    return importlib.import_module("src.legacy.sections_app.ui.debug_viewer")
