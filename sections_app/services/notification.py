...
def ask_confirm(title: str, message: str, *, callback: Optional[Callable[[bool], None]] = None, default: bool = False, source: Optional[str] = None, meta: Optional[dict] = None) -> Callable[[bool], None]:
