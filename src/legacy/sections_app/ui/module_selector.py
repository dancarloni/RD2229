"""(Legacy) Module Selector Window (Tkinter).

This is a direct copy of the historical Tkinter implementation moved to
the `src.legacy` package to preserve behavior for legacy tests.
"""
