"""
Skeleton checks for V_Rd,c (no stirrups) based on SPEC_... (SPEC only). Numeric fixtures must be provided in tests.
"""
...
def vrdc_no_stirrups(inputs: dict) -> dict:
    ...
    Return VerificationResultItem-like dict with trace.run_id and norm_references[].
    """
    return {
        "ok": False,
        "value": None,
