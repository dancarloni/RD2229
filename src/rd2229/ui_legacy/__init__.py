...
if not _ENABLED:  # pragma: no cover - only enabled in legacy runs
    raise ImportError("Legacy UI is disabled. Set RD2229_LEGACY_UI=1 to enable legacy Tkinter modules.")

__all__ = ["module_selector", "main_window", "historical_main_window", "notification_center", "section_manager"]
